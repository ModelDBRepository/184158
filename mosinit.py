'''
Current clamp demo using Allen Brain's model 471086533.
...
from neuron471086533 import Neuron471086533
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron471086533(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 471086533; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-92.921295166)
        h.fcurrent()
